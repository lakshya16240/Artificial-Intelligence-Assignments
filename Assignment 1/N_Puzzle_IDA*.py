...
def process(a):
    ...
    if i == 0 and j == 0:
        ...
        if not test:
            ...
            # print("yolaa " + str(distance))
            if distance <= limiting_value:
...
while True:
    ...
    print("limi  " + str(count) + " " + str(limiting_value))
    ...
    if flag == 1:
        ...
        limiting_value = limiting_value + 2
        process_space.queue.clear()
        process_space.put((matrix.distance, matrix))
        processed.clear()
        processed.add(computeString(matrix.arr))
        count = 0
...
if flag == 1:
    ...
    print("number of nodes explored overall : " + str(node_count))
    print("number of nodes explored for the current limiting value : " +str(count))
